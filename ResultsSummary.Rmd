...
*NB: the lines are the default GAM from ggplot (I think thin plates?). They don't mean much but I found they were sometimes easy to visualise overall patterns when simulation replicates are very variable.*
...
```{r}ggplot(summarydiscallcomb, aes(x=m_disc, fill=MDMI_90)) + geom_histogram()
```
